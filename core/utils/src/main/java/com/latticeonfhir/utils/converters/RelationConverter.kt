package com.latticeonfhir.utils.converters
...
import com.latticeonfhir.core.utils.converters.responseconverter.RelationConverter.RelationMapping.femaleToFemale
...
import com.latticeonfhir.core.utils.converters.responseconverter.RelationConverter.RelationMapping.otherToUnknown
...
object RelationConverter {
    ...
    object RelationMapping {
        fun maleToMale(relationEntity: RelationEntity): RelationEnum {
        ...
        fun maleToFemale(relationEntity: RelationEntity): RelationEnum {
            return when (relationEntity.relation) {
        ...
        fun maleToOther(relationEntity: RelationEntity): RelationEnum {
            return when (relationEntity.relation) {
        ...
        fun maleToUnknown(): RelationEnum {
            return RelationEnum.UNKNOWN
        }

        fun femaleToMale(relationEntity: RelationEntity): RelationEnum {
            return when (relationEntity.relation) {
        ...
        fun femaleToFemale(relationEntity: RelationEntity): RelationEnum {
            return when (relationEntity.relation) {
        ...
        fun femaleToOther(relationEntity: RelationEntity): RelationEnum {
            return when (relationEntity.relation) {
        ...
        fun femaleToUnknown(): RelationEnum {
            return RelationEnum.UNKNOWN
        }

        fun otherToMale(relationEntity: RelationEntity): RelationEnum {
            return when (relationEntity.relation) {
        ...
        fun otherToFemale(relationEntity: RelationEntity): RelationEnum {
            return when (relationEntity.relation) {
        ...
        fun otherToOther(relationEntity: RelationEntity): RelationEnum {
            return when (relationEntity.relation) {
        ...
        fun otherToUnknown(): RelationEnum {
            return RelationEnum.UNKNOWN
        }
    }
}