package com.latticeonfhir.utils.converters.responseconverter.medication
...
object MedicationInfoConverter {
    internal fun getMedInfo(
        ...
        return context.getString(
            ...
            qtyPerDose,
            medUnit,
            com.latticeonfhir.utils.converters.responseconverter.medication.MedicationInfoConverter.getMedFreqValue(
                frequency,
                context
            ),
