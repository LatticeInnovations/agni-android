...
import com.latticeonfhir.core.database.entities.patient.PatientAndIdentifierAndAppointmentEntity
...
import com.latticeonfhir.core.utils.converters.TimeConverter.lastMonth
import com.latticeonfhir.core.utils.converters.TimeConverter.lastThreeMonth
import com.latticeonfhir.core.utils.converters.TimeConverter.lastWeek
import com.latticeonfhir.core.utils.converters.TimeConverter.lastYear
...
import com.latticeonfhir.core.utils.converters.TimeConverter.toAppointmentTime
...
object Queries {
    ...
    suspend fun updateStatusToArrived(
        patient: PatientResponse,
    ...
    suspend fun getSearchListWithLastVisited(
        lastVisited: String,
    ...
    suspend fun checkAndUpdateAppointmentStatusToInProgress(
        inProgressTime: Date,
        patient: PatientResponse,
