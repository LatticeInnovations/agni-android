...
class AppointmentScreenViewModelTest : BaseClass() {
    ...
    fun getAppointmentsListTest() = runBlocking {
        ...
        assertEquals(appointmentResponseLocal, viewModel.todaysAppointment)
    ...
    fun updateStatusToArrivedTest_appointment_id_is_not_null() = runTest {
        viewModel.todaysAppointment = appointmentResponseLocal
        `when`(
            appointmentRepository.updateAppointment(
                appointmentResponseLocal.copy(
    ...
    fun updateStatusToArrivedTest_appointment_id_is_null() = runTest {
        viewModel.todaysAppointment = appointmentResponseLocalNullFhirId
        `when`(
            appointmentRepository.updateAppointment(
                appointmentResponseLocalNullFhirId.copy(
                    status = AppointmentStatusEnum.ARRIVED.value
    ...
    fun addPatientToQueueTest_existing_schedule() = runTest {
        ...
        `when`(preferenceRepository.getOrganizationFhirId()).thenReturn(appointmentResponseLocal.orgId)
        val slot = Slot(
