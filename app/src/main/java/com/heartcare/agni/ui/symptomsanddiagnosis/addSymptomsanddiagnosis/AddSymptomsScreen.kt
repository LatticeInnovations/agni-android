...
import com.heartcare.agni.ui.symptomsanddiagnosis.components.BodyPartCard
import com.heartcare.agni.ui.symptomsanddiagnosis.components.BottomSheetLayout
                ...
                if (list.value.isNotEmpty()) {
                    ...
                    FlowRow(
                        ...
                        list.value.forEachIndexed { index, symptom ->
                            Timber.d("MOST SEarched: $symptom")
                            SymptomsCustomChip(
