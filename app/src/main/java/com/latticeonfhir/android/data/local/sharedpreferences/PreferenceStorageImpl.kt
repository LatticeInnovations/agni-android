...
class PreferenceStorageImpl(private val sharedPreferences: SharedPreferences) : PreferenceStorage {
    ...
    override val organizationFhirId by StringPreference(sharedPreferences, PREF_ORGANIZATION_FHIR_ID,"")
    override val organization by StringPreference(sharedPreferences, PREF_ORGANIZATION,"")
