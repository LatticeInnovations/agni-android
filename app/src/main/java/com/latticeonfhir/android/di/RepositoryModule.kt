...
import com.latticeonfhir.core.data.local.repository.labtest.LabTestRepositoryImpl
...
import com.latticeonfhir.core.data.local.repository.cvd.chart.RiskPredictionChartRepositoryImpl
import com.latticeonfhir.core.data.local.repository.cvd.records.CVDAssessmentRepository
...
import com.latticeonfhir.core.data.local.repository.file.DownloadedFileRepositoryImpl
...
import com.latticeonfhir.core.data.local.repository.identifier.IdentifierRepositoryImpl
import com.latticeonfhir.core.data.local.repository.medication.MedicationRepository
import com.latticeonfhir.core.data.local.repository.medication.MedicationRepositoryImpl
import com.latticeonfhir.android.data.local.repository.patient.PatientRepository
import com.latticeonfhir.core.data.local.repository.patient.PatientRepositoryImpl
import com.latticeonfhir.core.data.local.repository.patient.lastupdated.PatientLastUpdatedRepository
import com.latticeonfhir.core.data.local.repository.patient.lastupdated.PatientLastUpdatedRepositoryImpl
...
import com.latticeonfhir.core.data.local.repository.prescription.PrescriptionRepositoryImpl
import com.latticeonfhir.android.data.local.repository.relation.RelationRepository
import com.latticeonfhir.core.data.local.repository.relation.RelationRepositoryImpl
import com.latticeonfhir.android.data.local.repository.schedule.ScheduleRepository
import com.latticeonfhir.core.data.local.repository.schedule.ScheduleRepositoryImpl
import com.latticeonfhir.core.data.local.repository.search.SearchRepository
import com.latticeonfhir.core.data.local.repository.search.SearchRepositoryImpl
import com.latticeonfhir.android.data.local.repository.vital.VitalRepository
import com.latticeonfhir.core.data.local.repository.vital.VitalRepositoryImpl
import com.latticeonfhir.android.data.local.repository.symptomsanddiagnosis.SymDiagRepository
import com.latticeonfhir.core.data.local.repository.symptomsanddiagnosis.SymDiagRepositoryImpl
...
import com.latticeonfhir.core.data.local.repository.vaccination.impl.ImmunizationRecommendationRepositoryImpl
import com.latticeonfhir.core.data.local.repository.vaccination.impl.ImmunizationRepositoryImpl
import com.latticeonfhir.core.data.local.repository.vaccination.impl.ManufacturerRepositoryImpl
