...
abstract class AppointmentPatchUploadSyncWorker(
    ...
    override suspend fun doWork(): Result {
        setProgress(workDataOf(AppointmentPatchUpload to 0))
        return when (val response = getSyncRepository().sendAppointmentPatchData()) {
    ...
    companion object {
        const val AppointmentPatchUpload = "AppointmentPatchUpload"
    }
}