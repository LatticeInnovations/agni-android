    ...
    Column(
        ...
        Column(
            ...
            CustomTextField(
                ...
                if (it.matches(nameRegex) || it.isBlank()) viewModel.firstName = it
                viewModel.isNameValid =
            ...
            CustomTextField(
                ...
                if (it.matches(nameRegex) || it.isBlank()) viewModel.middleName = it
            }
            ...
            CustomTextField(
                ...
                if (it.matches(nameRegex) || it.isBlank()) viewModel.lastName = it
            }
